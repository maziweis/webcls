<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HelpCenter.aspx.cs" Inherits="SmarterClassroomWeb.StudentCenter.page.HelpCenter" %>
...
<body>
    <header class="headTitle"><a class="goback fl ifhide" id="btnBlack" href="#"><i></i>返回</a><label>帮助中心</label></header>
    <div class="helpMain">
