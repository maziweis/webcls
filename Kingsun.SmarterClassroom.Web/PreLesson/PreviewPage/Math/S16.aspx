<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="S16.aspx.cs" Inherits="SmarterClassroomWeb.PreLesson.PreviewPage.Math.S16" %>
                        ...
                        $.each(data.Data, function (i) {
                            if (this.ParentID != null && this.ParentID != "") {
                                ...
                                AnswerHtml += "<td><input class=\"\" name=\"txtAnswer\" num=\"" + queNum + "\" id=\"" + this.QuestionID
                                              ...
                                              + "\"/>" + Common.MatchFenShi(this.QuestionContent.replace(/\\n/g, '<br/>').replace(/\/n/g, '<br/>'))
                                              + "</td>";
                                if (queNum % 2 == 0) {
                                    AnswerHtml += "</tr><tr>";
                                }
        ...
        function ImgClick(ImgNum) {
            ...
            if (allText[AnsweIndex - 1] != undefined) { //判断当前答案输入框是否存在
                ...
                if (AccessType == 3) { //学生做题，实时保存答案
                    ...
                    //var obj = { QuestionID: $(allText[AnsweIndex - 1]).attr("id"), StuTaskID: StuTaskID, Answer: ImgNum, Isright: Isright, spendTime: spendTime, ParentID: ParentID };
