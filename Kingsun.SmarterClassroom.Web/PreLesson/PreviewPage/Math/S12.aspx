<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="S12.aspx.cs" Inherits="SmarterClassroomWeb.PreLesson.PreviewPage.Math.S12" %>
        ...
        $(function () {
            ...
            $.post(Constant.SunnyTask + "TaskApi/Question/GetQuestionInfo", obj, function (data) {
                if (data.Success) {
                    ...
                    if (question.ImgUrl != "") {
                        questionHtml += '<img src="' + question.ImgUrl + '" onclick="window.parent.FullScreen(\'' + question.ImgUrl + '\')" alt="" title="点击图片可放大" />';
                    }
                        ...
                        if (IsDo) {
                            if (value.Sort == question.StuAnswer.Answer) {
                                questionHtml += '<td><a href="javascript:void(0)" class="on" onclick="Click(this)" id="' + value.Sort
                                    + '"><em class="em">' + String.fromCharCode(64 + parseInt(value.Sort)) + '</em><span class="MathSp">'
                                    + Common.MatchFenShi(value.SelectItem.replace(/\\n/g, "<br/>").replace(/\/n/g, "<br/>").replace("[", "<u>").replace("]", "</u>")) + '</span></a></td>';
                            } else {
                                questionHtml += '<td><a href="javascript:void(0)" onclick="Click(this)" id="' + value.Sort + '"><em class="em">'
                                    + String.fromCharCode(64 + parseInt(value.Sort)) + '</em><span class="MathSp">'
                                    + Common.MatchFenShi(value.SelectItem.replace(/\\n/g, "<br/>").replace(/\/n/g, "<br/>").replace("[", "<u>").replace("]", "</u>")) + '</span></a></td>';
                            }
                        } else {
                            questionHtml += '<td><a href="javascript:void(0)" onclick="Click(this)" id="' + value.Sort + '"><em class="em">'
                                    + String.fromCharCode(64 + parseInt(value.Sort)) + '</em><span class="MathSp">'
                                    + Common.MatchFenShi(value.SelectItem.replace(/\\n/g, "<br/>").replace(/\/n/g, "<br/>").replace("[", "<u>").replace("]", "</u>")) + '</span></a></td>';
                            //questionHtml += '<td><a href="javascript:void(0)" onclick="Click(this)" id="' + value.Sort + '"><em class="em">' + String.fromCharCode(64 + parseInt(value.Sort)) + '</em><span class="MathSp">' + '钟伟鹏哥好帅啊5<span class="MathJye"><table class="table" style="margin-right:1px" cellpadding="0" cellspacing="0"><tbody><tr><td style="border-bottom:1px solid white">1</td></tr><tr><td>3</td></tr></tbody></table></span>' + '</span></a></td>';
                        }
                        if (value.Sort % 2 == 0) {
                            questionHtml += '</tr><tr>';
                        }
