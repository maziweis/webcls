<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="S13.aspx.cs" Inherits="SmarterClassroomWeb.PreLesson.PreviewPage.Math.S13" %>
...
<body>
    ...
    <script type="text/javascript">
                    ...
                    $.post("?action=saveWQue&rand=" + Math.random(), obj, function (data) {
                        if (data) {
                            ...
                            if (data.Success) {
                                ...
                                //    alert("恭喜你，答对了！");
                                //} else {
                                //    alert("正确答案：" + (modelAnswer.split('_')[1] == "TRUE" ? "√" : "×"));
                                //}
        ...
        function SaveAnswer(answer, spendTime) {
            //obj = { QuestionID: QuestionID, StuTaskID: StuTaskID, Answer: answer, IsRight: answer == modelAnswer.split('_')[0] ? 1 : 0, SpendTime: spendTime, ParentID: ParentID }
            var stuScore = 0;
            var isRight = 0;
            var parentQScore = 0;
