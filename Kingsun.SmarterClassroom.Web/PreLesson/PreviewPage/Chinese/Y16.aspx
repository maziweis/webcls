<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Y16.aspx.cs" Inherits="SmarterClassroomWeb.PreLesson.PreviewPage.Chinese.Y16" %>
                    ...
                    if (data.Data.length != undefined) {
                        ...
                        $.each(data.Data, function (i) {
                            if (this.ParentID != null && this.ParentID != "") {
                                ...
                                AnswerHtml += "<span>"+this.QuestionContent + "</span></td>";
                                if (queNum % 2 == 0) {
                                    AnswerHtml += "</tr><tr>";
                                }
