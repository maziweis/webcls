<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Y22.aspx.cs" Inherits="SmarterClassroomWeb.PreLesson.PreviewPage.Chinese.Y22" %>
...
<body>
    ...
    <div class="Y Y21" id="textinfo">
    </div>
    <div class="Y Y22" id="notext" style="display:none;">
        <div class="shell"><p>背一背</p></div>
    </div>
    </form>
</body>
    <script type="text/javascript">
        ...
        function resizeWindow() {
            ...
            $("#textinfo").niceScroll({ touchbehavior: false, autohidemode: false, cursorcolor: "#dcdcdc", cursoropacitymax: 1, cursorwidth: 8 });
        }
        ...
        function ShowPoetry(content) {
            ...
            //有拼音
            if (content[2].SecondContent != "") {
                essayHtml += '<div class="pshell"><ol class="pytitle" style="width:' + len * 55 + 'px">';
                for (var i = 0; i < content.length; i++) {
                    if (content[i].ParentID != "") {
                        if (i == 1) {
                            //标题
                ...
                essayHtml += '<div class="pshell"><ol style="width:' + len * 30 + 'px">';
                for (var i = 0; i < content.length; i++) {
                    if (content[i].ParentID != "") {
                        if (i == 1) {
                            //标题
            ...
            $("#textinfo").html(essayHtml + '</ol></div>');
            var w = "";
