<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Y17.aspx.cs" Inherits="SmarterClassroomWeb.PreLesson.PreviewPage.Chinese.Y17" %>
                    ...
                    if (data.Data.length != undefined) {
                        ...
                        $.each(data.Data, function (i) {
                            if (this.ParentID != null && this.ParentID != "") {
                                ...
                                $("#h_QuestionContent").html(this.QuestionContent);
                            }
                        });
