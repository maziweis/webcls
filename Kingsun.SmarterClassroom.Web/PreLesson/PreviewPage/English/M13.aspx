<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="M13.aspx.cs" Inherits="SmarterClassroomWeb.PreLesson.PreviewPage.English.M13" %>
        ...
        $(function () {
            ...
            $.post(Constant.SunnyTask + "TaskApi/Question/GetQuestionInfo", obj, function (data) {
                if (data.Success) {
                    ...
                    //$(".topic").html(data.Data.QuestionTitle);
                    //题目Html
                    var questionHtml = "";
