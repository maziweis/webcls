<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="M18.aspx.cs" Inherits="SmarterClassroomWeb.PreLesson.PreviewPage.English.M18" %>
                                ...
                                if (isDo) {
                                    ...
                                    if (data.Data[i].StuAnswer.Answer == value.Sort) {
                                        questionHtml += '<td><a href="javascript:void(1)" class="on" onclick="liClick(this)" id="' + data.Data[i].QuestionID + '_' + value.Sort + '_' + data.Data[i].Sort + '"><em class="em">'
                                            + (String.fromCharCode(64 + value.Sort)) + '</em><span>' + value.SelectItem.replace(/\\n/g, "<br/>").replace(/\/n/g, "<br/>").replace("[", "<u>").replace("]", "</u>") + '</span></a></td>';
                                    }
                                    else {
