<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="M5.aspx.cs" Inherits="SmarterClassroomWeb.PreLesson.PreviewPage.English.M5" %>
    ...
    <script type="text/javascript">
                    ...
                    for (var i = 0; i < data.Data.length; i++) {
                        ...
                        if (data.Data[i].ParentID == "") {
                            ...
                            if (data.Data[i].ImgUrl) {
                                questionHtml += '<img src="' + data.Data[i].ImgUrl + '" alt="" />';
                            }
                            //题目音频
                            ...
                            questionHtml += '<div class="optionDiv">';
                            if (data.Data[i].QuestionModel.substring(0, 1) == "M") {
                                questionHtml += '<div class="num">(' + i + ')</div>';
                            } else {
                                questionHtml += '<div class="num">（' + i + '）</div>';
                            }
        ...
        function liClick(index) {
            ...
            if (AccessType == 4 || AccessType == 5) {
                //检查是否全部选择
                var num = 0;
                $.each($(".optionDiv table tr td a"), function (index) {
                    if ($("#" + (this.id)).hasClass("on")) {
                        num += 1;
                        stuAnswer[num - 1] = this.id.split('_')[1];
                    }
                });
                ...
                if (num == minQNum) {
                    ...
                    var isRight = 1;
                    var jnum = 0;
                    $.each($(".optionDiv table tr td a"), function (i) {
                        if ($("#" + (this.id)).hasClass("on")) {
