<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="M14.aspx.cs" Inherits="SmarterClassroomWeb.PreLesson.PreviewPage.English.M14" %>
            ...
            $.post(Constant.SunnyTask + "TaskApi/Question/GetQuestionInfo", obj, function (data) {
                if (data.Success) {
                    ...
                    $.each(question.SelectList, function (index, value) {
                        if (value.SelectItem.replace(/<u>/g, "").replace(/<\/u>/g, "").length > maxLen) {
                            maxLen = value.SelectItem.replace(/<u>/g, "").replace(/<\/u>/g, "").length;
                        }
                    });
