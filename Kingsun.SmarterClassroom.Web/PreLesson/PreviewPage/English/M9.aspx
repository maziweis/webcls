<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="M9.aspx.cs" Inherits="SmarterClassroomWeb.PreLesson.PreviewPage.English.M9" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            AccessType = Common.QueryString.GetValue("AccessType");//页面类型：
            //AccessType = 4;
            //M9 调试地址
            //http://192.168.3.94:8010/QuestionModels/M9.aspx?QuestionID=066D09F4-2F30-4473-8829-042AF82F70E2&AccessType=3&StuTaskID=461713c7-9b95-4ada-bf53-93b38c9f00c9
            ...
            $.post(Constant.SunnyTask + "TaskApi/Question/GetQuestionInfo", obj, function (data) {
                if (data.Success) {
                    ...
                    if (data.Data.length != undefined) {
                        if (data.Data[0].Mp3Url != "") {
                            //听力题 直接调用播放控件
                            window.parent.InitPlay(data.Data[0].Mp3Url);
                        }
                        var txtHtml = "";
                        var AnswerHtml = "";
                        var queNum = 1;
                        ...
                        $.each(data.Data, function (i) {
                            if (this.ParentID != null && this.ParentID != "") {
                                //当前题为小题
                                //<li><a class="on" href="javascript:void(0)"><em class="em">1</em><p>Sit down,please</p></a></li>
                                txtHtml += "<li onclick=\"txtClick('" + queNum + "')\"><a href=\"javascript:void(0)\"><em class=\"em\">"
                                    + queNum + "</em><p>" + this.QuestionContent + "</p></a></li>";

                                //ImgHtml += "<li onclick=\"ImgClick('" + queNum + "')\"><a class=\"on\" href=\"javascript:void(0)\">" +
                                ...
                                //" + (queNum == 1 ? "on" : "") + "
                                AnswerHtml += "<li><input class=\"\" name=\"txtAnswer\" num=\"" + queNum + "\" QueAnswer=\"\" id=\""
        ...
        function txtClick(ImgNum) {
            ...
            if (allText[AnsweIndex - 1] != undefined) { //判断当前答案输入框是否存在
                ...
                if (AccessType == 3) { //学生做题，实时保存答案
                    ...
                    //var obj = { QuestionID: qid, StuTaskID: StuTaskID, Answer: Answer, Isright: Isright, spendTime: spendTime, ParentID: ParentID };
