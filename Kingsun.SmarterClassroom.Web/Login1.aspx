<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login1.aspx.cs" Inherits="SmarterClassroomWeb.Login" %>
...
<body class="bgImg" onselectstart="return false;">
    ...
    <form id="form1" runat="server">
        ...
        <div class="copyRight">&copy;&nbsp;2017&nbsp;&nbsp;&nbsp;&nbsp;深圳市方直科技股份有限公司&nbsp;&nbsp;&nbsp;&nbsp;<b style="font-weight:normal" id="name01">深圳市华英智联通信技术有限公司</b></div>
