...
namespace Kingsun.SmarterClassroom.Com
{
    public class DES
    {
        ...
        {
            string key = "U308kd5c";
            string resutl = getMd5(key).Substring(0, 8);
            return resutl;//密匙
        }
        ...
        public static string Decrypt(string pToDecrypt)
        {
            ...
            try
            {
                result = Decrypt(pToDecrypt, getMd5Key());
            }
            catch { }
            return result;
        }
        ...
        {
            return Encrypt(pToEncrypt, getMd5Key());
        }


        ////////////////////////////////与winform交互///////////////////////////////////

        private static string getFormKey()
        {
            return "U308kd5c";
        }
        /// <summary>
        ...
        /// <param name="pToDecrypt">被解密的字符串</param>
        /// <returns>返回被解密的字符串</returns>
        public static string GetFormDecrypt(string pToDecrypt)
        {
            string result = "";
            try
            {
                result = Decrypt(pToDecrypt, getFormKey());
            }
            catch { }
            return result;
        }
        ...
        /// <param name="pToEncrypt">加密字符串</param>
        /// <returns></returns>
        public static string GetFormEncrypt(string pToEncrypt)
        {
            return Encrypt(pToEncrypt, getFormKey());
        }
    }
}
